...
create table if not exists public.profiles (
  ...
  tier text default 'grace' check (tier in ('grace', 'devotion', 'divine')),
...
alter table public.profiles add column if not exists tier text default 'grace' check (tier in ('grace', 'devotion', 'divine'));
